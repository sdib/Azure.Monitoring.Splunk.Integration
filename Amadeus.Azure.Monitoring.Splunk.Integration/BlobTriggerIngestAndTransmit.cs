	...
	public static class BlobTriggerIngestAndTransmit
	{
			...
			ILogger log)
		{
			...
			if (nsgSourceDataAccount.Length == 0)
			{
				...
				throw new ArgumentNullException("nsgSourceDataAccount", "Please provide setting.");
			}
			...
			if (blobContainerName.Length == 0)
			{
				...
				throw new ArgumentNullException("blobContainerName", "Please provide setting.");
			}
			...
			if (outputBinding.Length == 0)
			{
				...
				throw new ArgumentNullException("outputBinding", "Please provide setting.");
			}
